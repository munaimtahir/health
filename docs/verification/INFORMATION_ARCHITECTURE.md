...
The mapping is implemented in `app/src/main/kotlin/com/vexel/passport/VexelHealthPassportApp.kt`. Administrative tools are intentionally kept under Profile so they do not compete with routine health-record tasks.
