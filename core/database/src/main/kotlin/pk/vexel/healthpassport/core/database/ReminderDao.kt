...
interface ReminderDao {
    ...
    @Query("UPDATE reminders SET dueAtEpochMillis = :dueAt, status = 'SCHEDULED', updatedAtEpochMillis = :updatedAt WHERE id = :id") suspend fun reschedule(id: String, dueAt: Long, updatedAt: Long)
